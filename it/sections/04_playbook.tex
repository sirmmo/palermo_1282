...
\subsection{L'Ingegnera}
{\cinzel\footnotesize\color{grigionote} Greta degli Ingegni}\\
\textit{Costruisci ciò che la rete non può comprare. Ogni tuo
strumento è un'arma o un alibi.}

\textbf{Azioni di punta:} Studiare, Agire\\
\textbf{Azioni secondarie:} Tramare, Manovrare, Persuadere, Resistere

\textbf{Background:} Greta è cresciuta nella bottega di un orafo
del Cassaro che riparava anche orologi normanni e meccanismi arabi
sopravvissuti dal tempo di Ruggero II. Quando suo padre è morto,
ha preso le commesse — e i committenti hanno scoperto una mano
più precisa della sua. Il Mercante l'ha avvicinata due anni fa
per qualcosa di più delicato di una sveglia da corte: tubi
sigillati che si rompono se forzati, specchi montati su perni
che mandano segnali a chilometri, serrature che si aprono solo
a una sequenza di battiti. Quello che fa per la cospirazione
non è in nessun registro. Quello che fa per la corte angioina
è il suo alibi.

\textbf{Dono — L'oggetto giusto:} Una volta per scena, puoi
dichiarare di aver portato (o di costruire sul momento) un piccolo
dispositivo meccanico che risolve un problema specifico: un
grimaldello, uno specchio segnaletico, un tubo cifrato, un'esca
per serrature, un innesco a tempo. Concorda con il GM cosa fa.
Non servono tiri: funziona la prima volta. Si rompe o si consuma
all'uso.

\textbf{Fardello — La firma del maestro:} Ogni tuo lavoro porta
tracce della tua mano. Tieni il conto: dopo il terzo dispositivo
che lasci in giro o che cade in mani angioine, il GM può
dichiarare che qualcuno sta collegando i pezzi. La rete perde
1 punto.

\textbf{Legame iniziale:} Il Mercante ti finanzia. Sa che i
tuoi strumenti valgono oro — sospetta che valgano molto di più,
...
\subsection{La Filosofa Naturale}
{\cinzel\footnotesize\color{grigionote} Greta di Caltabellotta}\\
\textit{Tutto ciò che si muove obbedisce a leggi. Tutto ciò che
obbedisce a leggi si può prevedere — anche gli uomini.}

\textbf{Azioni di punta:} Studiare, Persuadere\\
\textbf{Azioni secondarie:} Tramare, Comandare, Resistere, Invocare

\textbf{Background:} Figlia minore di una casata baronale
dell'entroterra, Greta ha avuto in dote una biblioteca invece che
un convento. Ha studiato latino, greco, qualche parola d'arabo,
e i trattati di meccanica e di astronomia che suo nonno aveva
collezionato alla corte sveva. Suo padre tollera. Suo fratello
— il Barone — la usa: le sue dimostrazioni di meccanica e i
suoi calcoli sulle maree sono diventati uno strumento sociale,
e i suoi salotti notturni a Palermo radunano gente che altrimenti
non si parlerebbe. Non ha figli. Non ha mariti. Ha una macchina
ad acqua che riproduce il moto dei pianeti, e alcune persone
vengono solo per vederla muoversi.

\textbf{Dono — La dimostrazione:} Quando dimostri pubblicamente
un principio (meccanico, matematico, naturale), il pubblico ti
accorda autorità sulle materie collegate. Una volta per scena,
puoi usare Persuadere con effetto Eccezionale verso chiunque
abbia assistito a una tua dimostrazione durante la sessione.

\textbf{Fardello — Lo sguardo della Chiesa:} Una donna che spiega
come funzionano le cose attira sospetti che gli uomini eviterebbero.
Ogni volta che mostri pubblicamente sapere che non è considerato
proprio del tuo stato, il GM avanza l'orologio del Sant'Uffizio.
Quando è pieno, la tua biblioteca viene perquisita — e i tuoi
appunti finiscono in mani sbagliate.

\textbf{Legame iniziale:} La Castellana ospita le tue serate. Le
piace ascoltarti, anche se finge il contrario. Fra voi c'è
qualcosa che non avete mai detto.
...
\subsection{La Copista}
{\cinzel\footnotesize\color{grigionote} Suor Greta di Monreale}\\
\textit{Ogni pagina che ricopio è una scelta. Ogni scelta è un
atto politico — anche se nessuno se ne accorge.}

\textbf{Azioni di punta:} Studiare, Tramare\\
\textbf{Azioni secondarie:} Persuadere, Manovrare, Resistere, Invocare

\textbf{Background:} Suor Greta è entrata a Monreale a tredici
anni perché sua madre temeva che imparasse troppo a casa. Ha
trovato lo scriptorium pieno di trattati arabi sopravvissuti
alle perquisizioni di tre regimi: matematica, idraulica, automi,
le rotelle che muovevano gli orologi della corte di Ruggero II.
Ricopia, traduce, e talvolta costruisce piccoli modelli per
capire cosa il testo descrive. Il Sacrista viene a chiederle
perché la campana di Santo Spirito stona. Il Canonico le manda
manoscritti che non vuole archiviare ufficialmente. Tutti sanno
che sa. Nessuno scrive il suo nome nei registri.

\textbf{Dono — La biblioteca segreta:} Hai accesso a testi che
la curia ufficiale non ammette di possedere — ingegneria araba,
filosofia naturale, registri dimenticati. Una volta per sessione,
puoi dichiarare di aver trovato un testo rilevante per la
situazione attuale. Il GM ne definisce il contenuto, ma deve
essere concreto e usabile (un meccanismo, un nome, una procedura).

\textbf{Fardello — Il voto e la curiosità:} Hai preso voti. Non
sono in conflitto con la tua sete di sapere — ma la Chiesa non
sempre concorda. Se riveli a un non-religioso quanto sai
veramente, subisci 1 Stress per la rottura del decoro.

\textbf{Legame iniziale:} Il Sacrista mantiene gli orologi e le
campane di Santo Spirito. Tu gli hai insegnato come funzionano.
Ti deve più di quanto lui stesso sappia.
...
\subsection{La Maestra di Bottega}
{\cinzel\footnotesize\color{grigionote} Greta la Stagnaia}\\
\textit{La gente ti porta cose rotte. Tu gliele rendi guarite.
Mentre aspettano, ti raccontano tutto.}

\textbf{Azioni di punta:} Persuadere, Agire\\
\textbf{Azioni secondarie:} Studiare, Aizzare, Manovrare, Resistere

\textbf{Background:} Il banco di Greta è all'angolo del Seralcadio,
dove i pescatori passano scendendo al porto e gli artigiani
salendo dal Cassaro. Aggiusta serrature, ripara secchi e
bilance, salda padelle, mette a posto piccoli orologi quando
capita. Mostra ai bambini un suo automa — una colombella che
batte le ali quando si gira una manovella — e per quel motivo
metà del quartiere conosce il suo nome. Suo padre era stagnaio
e lei ha preso il banco a sedici anni. Da allora il banco è
diventato un tribunale, una bocciofila, un confessionale, una
base d'informazioni. Lei aggiusta. La gente parla.

\textbf{Dono — Il banco aperto:} Il tuo banco è una piazza
pubblica. Una volta per scena, puoi dichiarare che una persona
specifica (PG o PNG presente nella zona) è venuta da te — per
riparare qualcosa, per guardare, o solo per parlare. Da quel
momento è disponibile per una conversazione, in posizione
narrativamente neutra.

\textbf{Fardello — Tutti ti vedono:} La tua visibilità è la tua
forza e la tua trappola. I funzionari angioini conoscono il
tuo nome. Ogni volta che organizzi qualcosa di concreto nel
quartiere (riunioni, segnali, distribuzioni), il GM avanza
l'orologio «soldati alla porta». Quando è pieno, vengono.

\textbf{Legame iniziale:} La Pescivendola ti porta clienti. In
cambio, tu aggiusti i pesi della sua bilancia — e sa che lo
sai. Quando il momento verrà, scoprirete chi protegge chi.
